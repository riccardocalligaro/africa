...
extension Animals {
    static func fetch() -> AnyPublisher<Animals, Error> {
        return AfricaAPI
            .shared
            .request(endpoint: .animals)
